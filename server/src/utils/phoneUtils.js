...
/**
 * Validates a Pakistani phone number and returns the canonical form.
 */
export function validatePhone(input) {
  const normalized = normalizePhone(input);
  if (!normalized) {
    return { valid: false, error: 'Enter a valid Pakistani number (e.g. 03001234567 or +923001234567)' };
  }
